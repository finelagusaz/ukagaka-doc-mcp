...
- MCP 仕様 2026-07-28（リクエスト単位の `_meta` エンベロープ）と、それ以前の `initialize` ハンドシェイク方式（2025-11-25 / 2025-06-18 / 2025-03-26 / 2024-11-05）の両方のクライアントを同じエンドポイントで受け付けます。stdio モードも同様に両方に対応します。
